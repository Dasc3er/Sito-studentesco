...
if ($options["autogestione"] != null) echo '
                                    <li><a href="' .
         $options["root"] . 'liberi">Studenti non iscritti</a></li>';
echo '
                                    <hr>
                        ...
                        <div class="panel panel-info text-center">
                            ...
                            <div class="panel-body">
                                <ul class="nav nav-pills nav-stacked">
                                    <li><a href="' .
         $options["root"] .
         'credenziali" target="_blank">Credenziali</a></li>
                                    <li><a href="' .
         $options["root"] . 'credenzialitot" target="_blank">Credenziali totali</a></li>
                                    <hr>';
if ($options["autogestione"] != null) echo '
                                    <li><a href="' .
         $options["root"] . 'schedecorsi" target="_blank">Schede corsi</a></li>
                                    <li><a href="' .
         $options["root"] . 'schedeclassi" target="_blank">Schede classi</a></li>
                                    <li><a href="' .
         $options["root"] . 'rand" target="_blank">Assegnati a random</a></li>
                                    <hr>';
echo '
                                    <li><i class="fa fa-credit-card-alt fa-2x"></i></li>
                                    <li><a href="' .
         $options["root"] . 'barcodes" target="_blank">Barcode degli studenti</a></li>
                                    <li><a href="' .
         $options["root"] .
         'bar" target="_blank">Scarica database barcode</a></li
                                </ul>
                            </div>
                        </div>
                    </div>
                ...
                <a href="' .
         $options["root"] . 'aggiorna" class="btn btn-warning btn-block btn-lg disabled" target="_blank">Aggiornamento studenti</a>
            </div>';
