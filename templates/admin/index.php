...
echo '
                    ...
                    <div class="col-xs-12 col-md-6">
                        <div class="panel panel-info text-center">
                            ...
                            <div class="panel-body">
                                <ul class="nav nav-pills nav-stacked">
                                    <li><a href="' . $options["root"] . 'mostra/credenziali" target="_blank">Credenziali</a></li>
                                    <li><a href="' . $options["root"] . 'mostra/credenziali-totali" target="_blank">Credenziali totali</a></li>
                                    <hr>';
if ($options["autogestione"] != null) echo '
                                    <li><a href="' . $options["root"] . 'mostra/corsi" target="_blank">Schede corsi</a></li>
                                    <li><a href="' . $options["root"] . 'mostra/classi" target="_blank">Schede classi</a></li>
                                    <li><a href="' . $options["root"] . 'mostra/random" target="_blank">Assegnati a random</a></li>
                                    <hr>';
echo '
                                    <li><i class="fa fa-credit-card-alt fa-2x"></i></li>
                                    <li><a href="' . $options["root"] . 'mostra/barcodes" target="_blank">Barcode degli studenti</a></li>
                                    <li><a href="' . $options["root"] . 'download/barcodes" target="_blank">Scarica database barcode</a></li
                                </ul>
                            </div>
                        </div>
                    </div>
