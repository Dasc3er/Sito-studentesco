...
// -------------------------------------------------- //
if (isset($huge)) $im = imagecreatetruecolor(800, 600);
else $im = imagecreatetruecolor(200, 150);
$black = ImageColorAllocate($im, 0x00, 0x00, 0x00);
$white = ImageColorAllocate($im, 0xff, 0xff, 0xff);
$red = ImageColorAllocate($im, 0xff, 0x00, 0x00);
$blue = ImageColorAllocate($im, 0x00, 0x00, 0xff);
if (isset($huge)) imagefilledrectangle($im, 0, 0, 800, 600, $white);
else imagefilledrectangle($im, 0, 0, 200, 150, $white);
